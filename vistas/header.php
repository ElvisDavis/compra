    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SIst</b>Compras</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>SISCOMPRAS</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../public/img/ia.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Elvis Pachacama</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../public/img/ia.jpg" class="img-circle" alt="User Image">
                    <p>
